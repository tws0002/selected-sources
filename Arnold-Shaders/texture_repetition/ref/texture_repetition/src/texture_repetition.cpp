...
shader_evaluate
{
   ...
   int mirrorE = (int)floor((thisBlock.x/AI_PI - floor(thisBlock.x/AI_PI))*10);
   int mirrorO = (int)floor((thisBlock.y/AI_PI - floor(thisBlock.y/AI_PI))*11);
   mirrorE = RANDOM[mirrorE];
   mirrorO = RANDOM[mirrorO];   
